...
export const metadata: Metadata = {
  ...
  description:
    "길이, 무게, 온도, 면적, 부피, 속도, 데이터 용량 등 다양한 단위를 무료로 변환하세요.",
};

export default function ConvertPage() {
  const category = getCategoryById("convert")!;
  const tools = getToolsByCategory("convert");
    ...
    <div className="mx-auto max-w-[720px] px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="grid gap-3">
        {tools.map((tool) => (
          ...
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-amber-50 text-converter dark:bg-amber-950">
