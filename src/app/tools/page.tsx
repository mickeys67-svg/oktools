...
export const metadata: Metadata = {
  ...
  description:
    "온라인 시계, 타이머, 스톱워치, 글자수 세기, 랜덤 번호 생성기, 로또 번호 추천, 종이 사이즈 변환기 등 무료 유틸리티 도구를 바로 사용하세요.",
  keywords: ["온라인도구", "무료유틸리티", "온라인시계", "타이머", "스톱워치", "글자수세기", "로또번호추천", "랜덤번호생성기", "종이사이즈", "A4크기"],
  openGraph: {
    url: "/tools",
    title: "온라인 도구 모음 - 시계, 타이머, 글자수 세기, 로또",
    description:
  ...
  return (
    <div className="mx-auto max-w-[720px] px-4 py-8 sm:px-6 sm:py-12">
      ...
      <section className="mb-8 rounded-2xl border border-gray-100 bg-white p-5 text-sm leading-7 text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
        ...
        <h3 className="mt-5 mb-2 text-sm font-bold text-gray-900 dark:text-gray-100">유튜브 트랙리스트 생성기</h3>
        ...
        <h3 className="mt-5 mb-2 text-sm font-bold text-gray-900 dark:text-gray-100">종이 사이즈 변환기 (NEW)</h3>
        <p>사륙전지·국전지·하드롱 전지부터 국판·신국판·4·6판, A·B·C 시리즈, ANSI·ARCH 도면, 명함·사진·신문까지 60+ 규격을 한 번에 모았습니다. mm·cm·inch·DPI 5단계 픽셀·포인트 동시 표시에 더해, 한국 인쇄 산업의 핵심 단위인 <strong>연(連 = 500매)</strong>과 <strong>평량(g/m²)</strong> 기반 종이 무게 계산기까지 내장해 인쇄소 발주·견적 계산에 바로 쓸 수 있습니다.</p>
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 8, "name": "종이 사이즈 변환기", "url": "https://www.oktools.co.kr/tools/paper-size" }
            ]
          }
        }) }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "A4 종이 크기를 픽셀로 변환하려면 어떻게 하나요?", "acceptedAnswer": { "@type": "Answer", "text": "종이 사이즈 변환기에서 A4를 선택하고 원하는 DPI(72/96/150/300/600)를 고르면 mm·cm·inch와 함께 픽셀 값이 즉시 표시됩니다. 예를 들어 A4(210×297mm)는 300 DPI에서 2480×3508 px, 72 DPI에서 595×842 px입니다." } }
          ]
        }) }}
      />
    </div>
