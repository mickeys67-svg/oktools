...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "육아휴직급여 계산기 - 2026년 기준 월별 수령액",
    description:
      "무료 육아휴직급여 계산기로 2026년 기준 월별 수령액과 총 급여를 계산하세요. 통상임금과 휴직 기간을 입력하면 첫째/둘째 구간에 따른 육아휴직급여를 확인할 수 있습니다.",
  },
  alternates: {
  ...
  return (
    <div className="mx-auto max-w-[720px] px-4 py-8 sm:px-6 sm:py-12">
      ...
      <section className="mt-10 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
        ...
        <p className="mt-4">
          육아휴직급여는 고용보험에서 지급하는 급여로, 자녀 1명당 최대 1년(12개월)까지 사용할 수 있습니다.
          부모 모두 사용 가능하며, 같은 자녀에 대해 부부가 동시에 또는 순차적으로 사용할 수 있습니다.
          통상임금은 기본급과 고정수당을 포함하며, 성과급이나 변동수당은 제외됩니다.
          신청은 휴직 시작일 30일 전까지 사업주에게 서면으로 하며, 급여는 고용센터에 별도 신청해야 합니다.
          급여의 25%는 복직 후 6개월 이상 근무 시 사후 지급됩니다.
        </p>
      </section>
